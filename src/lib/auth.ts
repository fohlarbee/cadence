...
// Roles (SQLite has no enums; we validate here). Cadence is admin-only for now,
// but the field is kept so the model can grow later.
...
// Every signed-in user is an admin; the dashboard is the single home.
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export const dashboardPathFor = (_role: Role): string => "/dashboard";
