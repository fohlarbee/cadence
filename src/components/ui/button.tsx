...
const variants: Record<Variant, string> = {
  primary:
    "bg-primary text-white font-semibold shadow-sm hover:bg-primary-soft active:translate-y-px",
  outline:
    "border border-hairline text-fg hover:border-primary/60 hover:bg-surface-2",
